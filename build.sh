...
${nuget_cmd} install src/gu_rest_api/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/gu_rest_api.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/gu_rest_api.dll \
-recurse:'src/gu_rest_api/*.cs' \
-doc:bin/gu_rest_api.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/gu_rest_api.dll was created successfully"
fi
