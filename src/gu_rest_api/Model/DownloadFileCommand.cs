...
namespace gu_rest_api.Model
{
    ...
    public partial class DownloadFileCommand :  IEquatable<DownloadFileCommand>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DownloadFileCommand {\n");
        ...
        {
            return this.Equals(input as DownloadFileCommand);
        }

        /// <summary>
        /// Returns true if DownloadFileCommand instances are equal
        /// </summary>
        /// <param name="input">Instance of DownloadFileCommand to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DownloadFileCommand input)
        {
            if (input == null)
                return false;
